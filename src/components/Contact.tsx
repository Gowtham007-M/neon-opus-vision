      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <Card className="glass-card border-none animate-slide-up">
              ...
              <CardContent className="space-y-2">
                <div className="font-semibold text-lg">Easwari Engineering College</div>
                <div className="text-muted-foreground">Department of Information Technology</div>
                <div className="text-muted-foreground">Ramapuram, Chennai</div>
            ...
            {/* Organizers */}
            <Card className="glass-card border-none animate-slide-up animate-delay-200">
              <CardHeader>
                <CardTitle className="text-secondary">Event Organizers</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {organizers.map((organizer, index) => (
                  <div key={index} className="p-4 rounded-lg bg-muted/30 backdrop-blur-sm">
                    <div className="font-semibold text-lg">{organizer.name}</div>
                    <div className="text-sm text-primary">{organizer.role}</div>
                    <div className="text-xs text-muted-foreground">{organizer.department}</div>
                  </div>
                ))}
              </CardContent>
            </Card>
            ...
            <div className="space-y-4">
              {contactInfo.map((contact, index) => (
                <Card key={index} className="glass-card border-none animate-slide-up" style={{animationDelay: `${(index + 3) * 200}ms`}}>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{contact.subvalue}</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="flex flex-col items-center justify-center">
            <Card className="glass-card border-none max-w-md w-full animate-scale-in">
              ...
              <CardContent className="text-center space-y-6">
                <div className="relative group">
                  <img 
                    ...
                    className="w-64 h-64 mx-auto rounded-xl glow transition-all duration-300 group-hover:scale-105"
                  />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button 
                      variant="outline"
                      size="lg"
                      className="border-secondary/50 text-secondary hover:bg-secondary/10 w-full"
                    >
                      Download QR Code
                    </Button>
                  </div>
            ...
            <div className="mt-8 text-center animate-slide-up animate-delay-400">
              <div className="glass-card p-6 max-w-md">
                <h3 className="text-xl font-bold text-accent mb-2">Special Challenge</h3>
